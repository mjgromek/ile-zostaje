...
| Skill count | Eight, not the six named in §2 and §6: `architecture-check`, `frontend-design`, `grill-me`, `ponytail`, `security-review`, `tdd`, plus `theme-factory` (`6920222`, tightened in `d628079`) and `discovery` (`88af69a`). |
