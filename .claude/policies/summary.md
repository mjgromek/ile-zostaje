...
"Added Fridge, listed it, 236 days shown" is the shape. **On any slice that shipped tests,
Δ is required here** — the checker's visible pass rate minus its held-out pass rate. One
