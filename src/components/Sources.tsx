...
export function Sources({ lang, rates }: Props) {
  ...
  const entries: Entry[] = [
    ...
    { labelKey: 'line.pit', cited: rates.pit.firstRatePercent, shown: pct(rates.pit.firstRatePercent) },
    { labelKey: 'line.pit', cited: rates.pit.secondRatePercent, shown: pct(rates.pit.secondRatePercent) },
    { labelKey: 'line.pit', cited: rates.pit.thresholdAnnualGrosz, shown: zl(rates.pit.thresholdAnnualGrosz) },
    { labelKey: 'line.pit', cited: rates.pit.taxReducingAnnualGrosz, shown: zl(rates.pit.taxReducingAnnualGrosz) },
    { labelKey: 'line.pit', cited: rates.pit.taxReducingMonthlyGrosz, shown: zl(rates.pit.taxReducingMonthlyGrosz) },
    { labelKey: 'line.pit', cited: rates.pit.deductibleCostsMonthlyGrosz, shown: zl(rates.pit.deductibleCostsMonthlyGrosz) },
    { labelKey: 'field.under26.label', cited: rates.youthRelief.annualLimitGrosz, shown: zl(rates.youthRelief.annualLimitGrosz) },
